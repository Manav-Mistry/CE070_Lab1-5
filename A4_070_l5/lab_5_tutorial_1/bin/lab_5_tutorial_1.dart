...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'vanilla cake',
    'choco lava cake'
  ]; //This is same as , final desserts = const['cheesecake','vanilla cake','choco lava cake'];
  // Below 3 will not work because list is const
  // desserts.add('Pineapple cake');
  // desserts.remove('Orange cake');
  // desserts[0] = 'mango cake';
  ...
  */
  ...
  // Challenge 3:
  User user1 = User(1, 'Manav');
  User user2 = User(2, 'Shawn');
  User user3 = User(3, 'Wayne');
